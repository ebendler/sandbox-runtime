import { describe, it, expect } from '../support/node-test-compat.js'
...
describe('whichSync', () => {
  ...
  it('should be running with Bun shim in Node environment', () => {
  ...
  it('should return same result as Bun.which shim directly', () => {
