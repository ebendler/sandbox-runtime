...
import { wrapCommandWithSandboxLinux } from '../../dist/sandbox/linux-sandbox-utils.js'
 ...
 */
describe('Symlink write path detection (unit)', { skip: linuxOnly }, () => {
 ...
 */
describe(
  'Symlink write path detection (integration)',
  { skip: linuxOnly },
  () => {
