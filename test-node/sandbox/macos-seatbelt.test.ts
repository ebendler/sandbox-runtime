...
} from '../../dist/sandbox/sandbox-schemas.js'
...
describe('macOS Seatbelt Read Bypass Prevention', { skip: macOSOnly }, () => {
...
describe('macOS Seatbelt Write Bypass Prevention', { skip: macOSOnly }, () => {
 ...
 */
describe(
  'macOS Seatbelt Unix Domain Socket Support',
  { skip: macOSOnly },
  () => {
...
describe('macOS Seatbelt Process Enumeration', { skip: macOSOnly }, () => {
